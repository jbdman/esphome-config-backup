...
if(git.run_git_command(["git", "submodule", "status"], os.path.join(os.path.dirname(__file__),"..", "..", "..")).startswith('-')):
    print("\033[32mINFO [config_backup] Initializing submodules...\033[0m")
